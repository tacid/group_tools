...
return array(
	...
	'group_tools:join:already:tooltip' => "Вы были приглашены в группу, поэтому может сразу к ней присоединится.",

	// menu
	'group_tools:menu:mail' => "Сообщение участникам",
	'group_tools:menu:invitations' => "Управление приглашениями",

	'admin:appearance:group_tool_presets' => "Group tool предустановки",
	...
	'group_tools:settings:auto_suggest_groups' => "Автоматически предлагать группы на странице 'Предлагаемые' основываясь на данных профайла. Будет дополнено предустановленными предлагаемыми группами. Если значение 'Нет', то будут показываться только предустановленные предложения групп (если таковые есть).",
	...
	'group_tools:settings:invite_members' => "Позволять участникам группы приглашать новых пользователей",
	'group_tools:settings:invite_members:default_off' => "Да, по умолчанию выключена",
	'group_tools:settings:invite_members:default_on' => "Да, по умолчанию включена",
	'group_tools:settings:invite_members:description' => "Админы/владельцы групп могут устанавливать эту настройку для своих групп",
	'group_tools:settings:domain_based' => "Разрешить доменные группы",
	'group_tools:settings:domain_based:description' => "Пользователь может присоединится к группе основанной на базе домена его e-mail. Во время регистрации они автоматически будут добавлены к группам основанным на домене их e-mail адреса.",
	...
	'group_tools:settings:listing:default' => "Закладка списка группы по умолчанию",
	'group_tools:settings:listing:available' => "Доступая закладка списка групп",
