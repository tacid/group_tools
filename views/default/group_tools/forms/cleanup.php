<?php
	...
	if(!empty($group) && ($group instanceof ElggGroup) && $group->canEdit()){
		...
		$form_body .= ":&nbsp;" . elgg_view("input/dropdown", array("name" => "owner_block", "options_values" => $noyes_options, "value" => $group->getPrivateSetting($prefix . "owner_block")));
		...
		$form_body .= ":&nbsp;" . elgg_view("input/dropdown", array("name" => "actions", "options_values" => $noyes_options, "value" => $group->getPrivateSetting($prefix . "actions")));
		...
		$form_body .= ":&nbsp;" . elgg_view("input/dropdown", array("name" => "search", "options_values" => $noyes_options, "value" => $group->getPrivateSetting($prefix . "search")));
		...
		$form_body .= ":&nbsp;" . elgg_view("input/dropdown", array("name" => "members", "options_values" => $noyes_options, "value" => $group->getPrivateSetting($prefix . "members")));
		...
		$form_body .= ":&nbsp;" . elgg_view("input/dropdown", array("name" => "featured", "options_values" => $featured_options, "value" => $group->getPrivateSetting($prefix . "featured")));
